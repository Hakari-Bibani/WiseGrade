...
def grade_assignment(code, uploaded_html, uploaded_png, uploaded_csv):
    """
    Grading function with improved logic and more robust checks.
    """
    ...
    grade = 0
    feedback = [] # For storing grading messages
    ...
    # ----- 3. Fetching Data from API (15 Points) -----
    ...
    # ----- 7. Text Summary Grading (20 Points) -----
...
def check_map_visualization(uploaded_html, correct_html):
  ...
  try:
    ...
    # To do: More specific verification of markers
            ...
            if not uploaded_summary.empty:
                ...
                # Check for small tolerance in values
                 ...
                 if len(uploaded_values) == len(correct_values):
                    ...
                    feedback_csv.append("Number of rows in the summary is incorrect")
            else:
                  feedback_csv.append("The summary file is empty")
      else:
          feedback_csv.append("Incorrect number of rows or columns")
