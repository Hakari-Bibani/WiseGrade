...
def show():
    ...
    # Student Information Container at the Top
    with st.container():
    ...
    # Split Assignment Details, Grading Details, and Code Submission into Separate Containers
    with st.container():
    ...
    # Code Submission Area in a Separate Container
    with st.container():
